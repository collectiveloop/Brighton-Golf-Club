 ...
 * 
 * Copyright: © 2009-2018 ZealousWeb Technologies.
...
function zwt_register_plugins_link ($links, $file) {
   ...
   if ($file == $base) {
       $links[] = '<a href="http://www.zealousweb.com/wordpress-plugins/contact-form-7-paypal-extension-pro/">' . __('PRO Version') . '</a>';
       $links[] = '<a href="http://www.zealousweb.com/wordpress-plugins/shop">' . __('More Plugins by ZealousWeb') . '</a>';
