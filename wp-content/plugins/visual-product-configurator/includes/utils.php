...
//                var_dump($value["options"]);
            ...
            case 'repeatable-fields' :
                ...
                if($value["popup"])
                {
                    ...
                    echo "<a class='o-modal-trigger button button-primary button-large thickbox' href='/?TB_inline&width=1100&inlineId=$modal_id' title='Component Options' data-modalid='$modal_id'>".__("Manage options", "vpc")."</a>";
                    echo "<div id='$modal_id' style='display: none;'>";
