...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2 class="center"><a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button btn btn-default"><i class="icon-cycle"></i> <?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
