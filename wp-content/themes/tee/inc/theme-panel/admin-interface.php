...
function propanel_siteoptions_add_admin() {
    ...
    $tt_page = add_theme_page('Theme Panel', 'Theme Panel', 'edit_theme_options', 'siteoptions','propanel_siteoptions_options_page');
...
function propanel_of_style_only() {
	wp_enqueue_style('admin-style', get_template_directory_uri().'/inc/theme-panel/admin-style.css');
	wp_enqueue_style('color-picker', get_template_directory_uri().'/inc/theme-panel/colorpicker.css');
}
...
function propanel_of_load_only() {
	...
	wp_register_script('jquery-input-mask', get_template_directory_uri().'/inc/theme-panel/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ));
	wp_enqueue_script('jquery-input-mask');
	wp_enqueue_script('color-picker', get_template_directory_uri().'/inc/theme-panel/js/colorpicker.js', array('jquery'));
	wp_enqueue_script('ajaxupload', get_template_directory_uri().'/inc/theme-panel/js/ajaxupload.js', array('jquery'));
