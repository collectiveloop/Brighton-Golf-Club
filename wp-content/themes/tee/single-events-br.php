	  			...
	  			<div class="row">
		  			...
		  			<div class="col-md-4">
		  				...
		  				<?php if( get_post_meta( get_the_ID(), 'tee_event_datetime', true ) != ""){ ?>
							    ...
							    ?>
								<p><span class="icon icon-calendar"></span> <?php echo tee_events_date($the_date); ?></p>
			    ...
			    jQuery(function($) {
				    ...
				    **/
				    ...
				    function setDate(){
				        ...
				        if( launch < now ){
				            days.html('<h1>0</h1><p><?php _e("Day","tee"); ?></p>');
				            hours.html('<h1>0</h1><p><?php _e("Hour","tee"); ?></p>');
				            minutes.html('<h1>0</h1><p><?php _e("Minute","tee"); ?></p>');
				            seconds.html('<h1>0</h1><p><?php _e("Second","tee"); ?></p>');
				        }
				        else{
				            ...
				            days.html('<h1>'+d+'</h1><p><?php _e("Day","tee"); ?>'+(d>1?'s':''),'</p>');
				            hours.html('<h1>'+h+'</h1><p><?php _e("Hour","tee"); ?>'+(h>1?'s':''),'</p>');
				            minutes.html('<h1>'+m+'</h1><p><?php _e("Minute","tee"); ?>'+(m>1?'s':''),'</p>');
				            seconds.html('<h1>'+s+'</h1><p><?php _e("Second","tee"); ?>'+(s>1?'s':''),'</p>');
